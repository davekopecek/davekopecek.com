...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<colorator>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<bundler>.freeze, ["~> 1.3".freeze])
  s.add_development_dependency(%q<octopress>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<rake>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<clash>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<aws-sdk-v1>.freeze, [">= 0".freeze])
